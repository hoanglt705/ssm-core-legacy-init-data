...
public class PosServiceConfig {
  ...
  public HessianServiceExporter hessianDataTestServiceExporter() {
    HessianServiceExporter exporter = new HessianServiceExporter();
    exporter.setService(dataTestService);
    exporter.setServiceInterface(IDataTestService.class);
    return exporter;
  }
  ...
  public HessianServiceExporter hessianSequenceNumberServiceExporter() {
    HessianServiceExporter exporter = new HessianServiceExporter();
    exporter.setService(sequenceNumberService);
